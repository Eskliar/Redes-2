...
**Sumarizar (o agregar rutas)** significa **unir varias redes contiguas en una sola red más grande**, usando una máscara más corta (CIDR), 
logrando **reducir el tamaño de la tabla de enrutamiento**.
...
Si contamos los bits de izquierda a derecha, 
empezando desde el primer octeto hasta la parte en la que dejan de coincidir, podemos ver que son **22 bits**.
