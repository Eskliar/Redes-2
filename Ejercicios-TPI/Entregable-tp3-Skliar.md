...
### Direcciones IPv4 asignadas con el bloque asignado 200.5.48.0/20

El objetivo es dividir el bloque 200.5.48.0/20 usando VLSM (Máscara de Subred de Longitud Variable) para cubrir todas las necesidades de la topología.
...
200.5.48.0/20 -> red original

|**1100 1000.0000 0101.0011**|0000.0000 0000 -> 20 bits de red originales

1100 1000.0000 0101.0011|**0000.0000 0000** -> 12 bits de host originales

1100 1000.0000 0101.0011 000|**0.0000 0000**| -> 9 bits tomados para los 500 hosts.


1100 1000.0000 0101.0011 |**000**|0.0000 0000 -> bits tomados para subnetting 

1100 1000.0000 0101.0011 |**111**|0.0000 0000 -> asignamos el limite superior de subnetting a la red

Nueva máscara de subred -> /23

200.5.62.0/23 -> **Dirección IP asignada para la red n14.**
Rango de subred: 200.5.62.0 – 200.5.63.255
Hosts útiles: 200.5.62.1 – 200.5.63.254
Broadcast: 200.5.63.255

Finalmente las direcciones: `200.5.48.0` hasta `200.5.61.255` quedan libres para seguir subneteando.

### Red n11/n13 de 328 hosts

Nuevamente necesitamos 9 bits entonces le asiganamos la próxima red disponible, decrementando en 1 los bits de subnetting

1100 1000.0000 0101.0011 |**110**|0.0000 0000 -> bits tomados para subnetting 

200.5.60.0/23 -> **Dirección IP asignada para la red n11/n13.**

Finalmente las direcciones: `200.5.48.0` hasta `200.5.59.255` quedan libres para seguir subneteando.

### Red n9 de 40 hosts

200.5.59.255 -> Red de la cual partimos.

1100 1000.0000 0101.0011 1011.1111 1111 -> red expresada en bits.

1100 1000.0000 0101.0011 1011.11|**00 0000**| -> Colocamos en cero los bits que necesitamos para hosts (en este caso 6).

1100 1000.0000 0101.0011 |**1011.11**|00 0000 -> Bits tomados para subred.

La nueva máscara de subred es /26

200.5.59.192/26 -> **Dirección IP asignada para la red n9.**

Finalmente las direcciones: `200.5.48.0` hasta `200.5.59.191` quedan libres para seguir subneteando.

### Red n10 de 2 hosts

200.5.59.191 -> Red de la cual partimos.

11001000.00000101.00111011.10111111 -> red expresada en bits

11001000.00000101.00111011.101111|**00**| -> Colocamos en cero los bits que necesitamos para hosts.

11001000.00000101.0011 |**1011.1011 11**|00 -> Bits tomados para subred.

La nueva máscara de subred será /30

200.5.59.188/30 -> **Dirección IP asignada para la red n10.**

Finalmente las direcciones: `200.5.48.0` hasta `200.5.59.187` quedan libres para seguir subneteando.

### Enlaces punto a punto

Nuevamente necesitamos 2 bits entonces le asiganamos la próxima red disponible de forma decremental

200.5.59.184/30 -> **Dirección IP asignada para enlace punto a punto número 1.**

200.5.59.180/30 -> **Dirección IP asignada para enlace punto a punto número 2.**

200.5.59.176/30 -> **Dirección IP asignada para enlace punto a punto número 3.**

200.5.59.172/30 -> **Dirección IP asignada para enlace punto a punto número 4.**

200.5.59.168/30 -> **Dirección IP asignada para enlace punto a punto número 5.**

200.5.59.164/30 -> **Dirección IP asignada para enlace punto a punto número 6.**

200.5.59.160/30 -> **Dirección IP asignada para enlace punto a punto número 7.**

200.5.59.156/30 -> **Dirección IP asignada para enlace punto a punto número 8.**

200.5.59.152/30 -> **Dirección IP asignada para enlace punto a punto número 9.**

200.5.59.148/30 -> **Dirección IP asignada para enlace punto a punto número 10.**

200.5.59.144/30 -> **Dirección IP asignada para enlace punto a punto número 11.**

Finalmente las direcciones: `200.5.48.0` hasta `200.5.59.143` quedan libres para seguir subneteando.
